...
export const SECURITY_SYNC_WORKER_AUTH_TOKEN = getEnvVariable('SECURITY_SYNC_WORKER_AUTH_TOKEN');
export const SECURITY_SYNC_WORKER_HMAC_SECRET = getEnvVariable('SECURITY_SYNC_WORKER_HMAC_SECRET');
