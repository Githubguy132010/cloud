...
ALTER TABLE "auto_fix_tickets" ADD CONSTRAINT "auto_fix_tickets_trigger_source_check" CHECK ("auto_fix_tickets"."trigger_source" IN ('label', 'review_comment'));--> statement-breakpoint
...
CREATE UNIQUE INDEX "UQ_auto_fix_tickets_repo_issue" ON "auto_fix_tickets" USING btree ("repo_full_name","issue_number") WHERE "auto_fix_tickets"."trigger_source" = 'label';
