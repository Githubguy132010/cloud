/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3f0c1f6abd4af3ae1d6ead3ea31b8f58)
// Runtime types generated with workerd@1.20260302.0 2025-09-15 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Sandbox" | "CloudAgentSession";
	}
	interface DevEnv {
	...
	interface Env {
		...
		KILO_SESSION_INGEST_URL: "http://localhost:8787" | "https://ingest.kilosessions.ai";
		Sandbox: DurableObjectNamespace<import("./src/index").Sandbox>;
		CLOUD_AGENT_SESSION: DurableObjectNamespace<import("./src/index").CloudAgentSession>;
		SESSION_INGEST: Service /* entrypoint SessionIngestRPC from session-ingest */;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_APP_SLUG" | "GITHUB_APP_BOT_USER_ID" | "GITHUB_LITE_APP_ID" | "GITHUB_LITE_APP_SLUG" | "GITHUB_LITE_APP_BOT_USER_ID" | "WRAPPER_IDLE_TIMEOUT_MS" | "CLI_TIMEOUT_SECONDS" | "REAPER_INTERVAL_MS" | "STALE_THRESHOLD_MS" | "PENDING_START_TIMEOUT_MS" | "R2_ATTACHMENTS_BUCKET" | "KILO_SESSION_INGEST_URL" | "NEXTAUTH_SECRET" | "INTERNAL_API_SECRET" | "KILOCODE_BACKEND_BASE_URL" | "KILO_OPENROUTER_BASE" | "WORKER_URL" | "GITHUB_APP_ID" | "GITHUB_APP_PRIVATE_KEY" | "WS_ALLOWED_ORIGINS">> {}
}
declare module "*.sql" {
	const value: string;
